...
## Practical Machine Learning Assignment
 ...
 The goal of this markdown will be to use data from accelerometers on the belt, forearm, arm, and dumbell of 6 participants to predict the manner in which they did the exercise. The report describes how the model was built, how it was cross validated, and why you different choices were made. 
...
Eight different packages are loaded
